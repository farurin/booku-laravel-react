  ...
  return (
    <div className="bg-white rounded-4xl border border-gray-100 shadow-sm p-6 sticky top-6 overflow-y-auto max-h-[calc(100vh-3rem)] custom-scrollbar">
      ...
      <div className="text-center mb-6">
        ...
        {category.name_en && (
          <p className="text-sm font-semibold text-blue-500 italic mb-2">
            "{category.name_en}"
          </p>
        )}
      ...
      <div className="mb-8">
        ...
        <p className="text-sm text-gray-800 leading-relaxed font-medium bg-gray-50 p-3 rounded-xl border border-gray-100">
          {category.description_id || "Tidak ada deskripsi."}
        </p>
        ...
        {category.description_en && (
          <>
            ...
            <p className="text-sm text-gray-800 leading-relaxed font-medium bg-gray-50 p-3 rounded-xl border border-gray-100 italic">
              {category.description_en}
            </p>
          </>
        )}
