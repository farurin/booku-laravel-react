...
const BookInfoBanner = ({ book, userRating = 0, totalPages = 0 }) => {
    ...
    return (
      <section className="w-full mt-8 mb-12">
        <div className="w-full max-w-7xl mx-auto px-4 md:px-8">
          <div className="w-full bg-white rounded-[40px] shadow-sm border border-gray-100 flex flex-col md:flex-row animate-pulse overflow-hidden">
  ...
  return (
    <section className="w-full mt-8 mb-12">
      <div className="w-full max-w-7xl mx-auto px-4 md:px-8">
        <div className="w-full bg-white rounded-4xl md:rounded-[40px] shadow-sm border border-gray-100 flex flex-col md:flex-row overflow-hidden">
          <div className="w-full md:w-1/3 lg:w-[35%] bg-booku-cream p-8 lg:p-12 flex items-center justify-center relative overflow-hidden shrink-0">
            ...
            <div className="w-full max-w-60 lg:max-w-75 aspect-2/3 rounded-2xl overflow-hidden shadow-2xl border-4 border-white z-10 rotate-2 hover:rotate-0 transition-transform duration-500 bg-white">
              <img
