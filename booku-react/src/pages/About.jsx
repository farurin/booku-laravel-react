...
const About = () => {
  ...
  return (
    <div className="w-full bg-booku-cream min-h-screen">
      {/* Memanggil title dan description agar muncul di Banner */}
      <BannerCorner title={t("about_heading")} description={t("about_desc")} />

      <div className="w-full max-w-5xl mx-auto px-4 md:px-8 py-12 md:py-16 flex flex-col items-center text-center">
        {/* Logo BookU */}
        ...
        {/* Teks Penjelasan (1 Paragraf Singkat) */}
        <div className="max-w-3xl flex flex-col gap-6 mb-12">
          <p className="text-gray-700 font-medium text-base md:text-lg leading-relaxed bg-white/50 p-8 md:px-12 rounded-[32px] shadow-sm">
            {t("about_p1")}
          </p>
        </div>
