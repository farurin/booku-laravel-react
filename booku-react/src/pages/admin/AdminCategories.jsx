...
const AdminCategories = () => {
  ...
  return (
    <div className="p-8 md:p-12 grid grid-cols-1 lg:grid-cols-3 gap-8 min-h-screen">
        ...
        <div className="space-y-4 flex-1">
          {paginatedCategories.length > 0 ? (
            paginatedCategories.map((cat) => (
              <CardCategories
                key={cat.id}
                // UPDATE: Lempar name_id dan description_id
                name_id={cat.name_id}
      ...
      <AdminConfirmModal
        ...
        description={`Apakah anda yakin ingin ${targetCategory?.status === "active" ? "menonaktifkan" : "mengaktifkan"} kategori "${targetCategory?.name_id}"?`}
        warningText={
          targetCategory?.status === "active"
      ...
      <AdminConfirmModal
        ...
        description={`Apakah anda yakin ingin menghapus kategori "${targetCategory?.name_id}"? Tindakan ini tidak dapat dibatalkan.`}
