...
export default function AdminDashboard() {
  ...
  const [data, setData] = useState({
    ...
    bookStatus: { popular: [], latest: [], least_viewed: [] },
    demography: [],
    recentSidebarBooks: [],
  });
            ...
            <div className="flex gap-6 mb-6 border-b border-gray-100 overflow-x-auto hide-scrollbar">
              {tabs.map((tab) => (
                <button
                  ...
                  className={`pb-3 text-sm font-bold transition-all whitespace-nowrap border-b-[3px] -mb-px cursor-pointer ${activeTab === tab ? "border-orange-400 text-[#8f30ff]" : "border-transparent text-slate-400 hover:text-slate-600"}`}
                >
                  {tab}
                </button>
              ))}
              ...
              {displayedBooks.map((book) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-[11px] font-bold text-slate-400 mt-0.5 truncate max-w-[120px]">
        ...
        <div className="w-full lg:w-72 flex flex-col gap-6 shrink-0">
          ...
          <div className="bg-white rounded-3xl p-5 shadow-sm border border-gray-100 flex-1">
            <div className="flex items-center justify-between mb-5">
              ...
              <Link
                to="/admin/books"
                className="text-[10px] font-black text-[#8f30ff] hover:text-[orange-600] flex items-center uppercase tracking-wider cursor-pointer"
              >
              ...
              {data.recentSidebarBooks.map((b) => (
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-[10px] font-bold text-slate-400 mt-0.5 truncate max-w-[120px]">
                      {b.attribution_text ? "Domain Publik" : "Funtasya Team"}
                    </p>
                  </div>
                </Link>
              ))}
